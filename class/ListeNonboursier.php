...
<html>
  ...
  include_once '../menu/menu.php';
    ?>
        ...
        <header>
         <h1 class="text-center">Liste des etudiants  Non Boursiers</h1>
         <header>
        ...
        $req  = $etudiantservice->ListeNBoursier('nonboursiers');
   
                        //$req = $connexion->query('SELECT * FROM `Etudiant`,  `nonboursiers` WHERE Etudiant.id_etudiant=nonboursiers.id_etudiant');
